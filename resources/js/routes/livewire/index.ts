...
* @route '/livewire-1f500cf5/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-1f500cf5/upload-file',
...
* @route '/livewire-1f500cf5/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-1f500cf5/preview-file/{filename}',
