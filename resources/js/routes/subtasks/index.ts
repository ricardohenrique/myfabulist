...
/**
* @see \App\Http\Controllers\Web\SubtaskController::update
* @see app/Http/Controllers/Web/SubtaskController.php:19
* @route '/subtasks/{subtask}'
*/
...
/**
* @see \App\Http\Controllers\Web\SubtaskController::destroy
* @see app/Http/Controllers/Web/SubtaskController.php:26
* @route '/subtasks/{subtask}'
*/
...
/**
* @see \App\Http\Controllers\Web\CompleteSubtaskController::__invoke
* @see app/Http/Controllers/Web/CompleteSubtaskController.php:16
* @route '/subtasks/{subtask}/complete'
*/
...
/**
* @see \App\Http\Controllers\Web\RestoreSubtaskController::__invoke
* @see app/Http/Controllers/Web/RestoreSubtaskController.php:16
* @route '/subtasks/{subtask}/restore'
*/
